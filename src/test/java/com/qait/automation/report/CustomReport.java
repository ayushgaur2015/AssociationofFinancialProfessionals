...
import com.qait.automation.utils.DateUtil;
	...
	public class CustomReport implements IReporter{
		...
		private String reportTitle= "AFP Automation Test Report";
		private String reportFileName = "AFP_Automation.html";
		...
		public void generateSuiteSummaryReport(List<ISuite> suites) {
			...
			for (ISuite suite : suites) {
				...
				for (ISuiteResult r : tests.values()) {
					...
					summaryCell(System.getProperty("browser").toUpperCase(), true);
					writer.println("</td>");
		...
		protected void startHtml(PrintWriter out) {
			...
			out.println("table {margin-bottom:10px;border-collapse:collapse;empty-cells:show}");
			out.println("td,th {border:1px solid #009;padding:.25em .5em}");
			out.println(".stacktrace {white-space:pre;font-family:cambria}");
